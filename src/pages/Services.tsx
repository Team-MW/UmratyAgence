...
export default function Services() {
    return (
        <>
            ...
            {/* Offres - Nouvelles Images Flyers */}
            <Section variant="light" className="bg-gray-50 pb-16 pt-16">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-12">
                        <h2 className="text-4xl md:text-5xl font-serif text-dark-900 mb-4">Nos Offres Actuelles</h2>
                        <div className="w-24 h-1 bg-primary-500 mx-auto rounded-full" />
                        <p className="mt-4 text-gray-600 max-w-2xl mx-auto">Découvrez nos formules spécialement conçues pour votre confort et bien-être.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {['service-img1.jpeg', 'service-img2.jpeg', 'service-img3.jpeg', 'service-img4.jpeg'].map((img, index) => (
                            <motion.div
                                key={index}
